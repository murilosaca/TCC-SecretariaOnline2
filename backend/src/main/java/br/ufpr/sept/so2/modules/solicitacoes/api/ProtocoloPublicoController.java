...
public class ProtocoloPublicoController {
    ...
    private final ConsultarProtocoloPublicoUseCase consultarProtocoloPublicoUseCase;

    public ProtocoloPublicoController(ConsultarProtocoloPublicoUseCase consultarProtocoloPublicoUseCase) {
        this.consultarProtocoloPublicoUseCase = consultarProtocoloPublicoUseCase;
    }

    @GetMapping("/{protocolo}")
    @Operation(summary = "Verificar protocolo sem autenticação")
    public ProtocoloPublicoResponse buscar(@PathVariable String protocolo) {
        return ProtocoloPublicoResponse.from(consultarProtocoloPublicoUseCase.execute(protocolo));
    }
}
