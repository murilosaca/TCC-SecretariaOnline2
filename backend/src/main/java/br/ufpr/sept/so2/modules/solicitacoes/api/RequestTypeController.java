...
public class RequestTypeController {
    ...
    private final ListarRequestTypesUseCase listarRequestTypesUseCase;
    private final SolicitacaoAssembler assembler;

    public RequestTypeController(
            ListarRequestTypesUseCase listarRequestTypesUseCase,
            SolicitacaoAssembler assembler
    ) {
        this.listarRequestTypesUseCase = listarRequestTypesUseCase;
    ...
    public PageResponse<RequestTypeResponse> listar(@PageableDefault(size = 20) Pageable pageable) {
    ...
    public RequestTypeResponse buscar(@PathVariable String codigo) {
        return assembler.from(listarRequestTypesUseCase.buscarPublicado(codigo));
    }
}
